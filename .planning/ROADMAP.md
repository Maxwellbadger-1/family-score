...
- [x] 04-04-PLAN.md — Wave 3: ActivityListView + ActivityRowView, App-Verdrahtung (TabView, @StateObject Injection), Test-Suite gruen, Geraete-Checkpoint (ausstehend — Code vollstaendig, CI-Run blockiert durch Billing)
...
| 4. Activity Logging & Dashboard | 4/4 | Checkpoint ausstehend | - |
